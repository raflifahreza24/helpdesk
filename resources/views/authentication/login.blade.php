...
<html lang="en">
   <head>
      <meta charset="utf-8" />
      <title>Log In | Boron - Responsive Neubrutalism Bootstrap 5 Admin Dashboard</title>
               ...
               <div class="card overflow-hidden text-center h-100 p-xxl-4 p-3 mb-0">
                  ...
                  <form action="{{ route('login') }}" method="POST" class="text-start mb-3">
                     ...
                     <div class="mb-3">
                        ...
                        <input type="email" id="ct-email" name="email" value="{{ old('email') }}" class="form-control" placeholder="Enter your email">
                     </div>

                     <div class="mb-3">
                        <label class="form-label" for="ct-password">Password</label>
                        <input type="password" id="ct-password" name="password" class="form-control" placeholder="Enter your password">
                     </div>
